...
if (isset($_POST["btnSubmit"])) {
        ...
        if (!$errorMsg) {
            ...
            $subject = "Website Appeal " . $todaysDate;
...
<article id="main">
    ...
    if (isset($_POST["btnSubmit"]) AND empty($errorMsg)) {
        print "<h3>Thank you. Your appeal will be reviewed shortly.</h3>";
        
    } else {
    
    print "<h2>Appeal</h2>";
    print "<p>Banned unfairly?</p>";
    print "<p>Ready to change your ways?</p>";
    print "<p>Appeal here.</p>";
    ...
    <form action="<?php print $phpSelf; ?>"
          ...
          method="post">
            ...
            <fieldset class="buttons">
                <legend></legend>
                <input class="button" id="btnSubmit" name="btnSubmit" type="submit" value="Appeal" >
